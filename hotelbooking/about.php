...
<head>
    ...
    <title>FM HOTEL | THÔNG TIN</title>
...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h-font text-center">THÔNG TIN CỦA CHÚNG TÔI</h2>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-4 px-4">
                <div class="bg-white rounded shadow p-4 border-top border-4 text-center t-color box">
            ...
            <div class="col-lg-3 col-md-6 mb-4 px-4">
                <div class="bg-white rounded shadow p-4 border-top border-4 text-center t-color box">
                    ...
                    <h4 class="mt-3">1000+ ĐÁNH GIÁ</h4>
                </div>
            </div>
